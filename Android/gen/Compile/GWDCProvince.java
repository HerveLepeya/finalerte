...
class GWDCProvince extends WDStructure
{
public WDObjet mWD_Id = new WDEntier4();
public WDObjet mWD_LibelleVille = new WDChaineU();
...
if(sNomMembre.equals("libelleville")) return mWD_LibelleVille;
...
case 1 : membre.m_refMembre = mWD_LibelleVille; membre.m_strNomMembre = "mWD_LibelleVille"; membre.m_bStatique = false; membre.m_strNomMembreWL = "LibelleVille"; membre.m_bSerialisable = true; membre.m_strNomSerialisation = null; membre.m_strMapping = null; membre.m_nOptCopie = 0; membre.m_nOptCopieEltTableau = 0; return true;
