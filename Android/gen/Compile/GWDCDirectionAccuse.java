 ...
 * Classe Android : DirectionAccuse
...
if(sNomMembre.equals("libelledirection")) return mWD_LibelleDirection;
...
case 1 : membre.m_refMembre = mWD_LibelleDirection; membre.m_strNomMembre = "mWD_LibelleDirection"; membre.m_bStatique = false; membre.m_strNomMembreWL = "LibelleDirection"; membre.m_bSerialisable = true; membre.m_strNomSerialisation = null; membre.m_strMapping = null; membre.m_nOptCopie = 0; membre.m_nOptCopieEltTableau = 0; return true;
...
case 3 : membre.m_refMembre = mWD_VilleId; membre.m_strNomMembre = "mWD_VilleId"; membre.m_bStatique = false; membre.m_strNomMembreWL = "VilleId"; membre.m_bSerialisable = true; membre.m_strNomSerialisation = null; membre.m_strMapping = null; membre.m_nOptCopie = 0; membre.m_nOptCopieEltTableau = 0; return true;
