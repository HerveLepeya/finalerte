 ...
 * Classe Android : FEN_Explorateur_Images
...
public class GWDFFEN_Explorateur_Images extends WDFenetre
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs de FEN_Explorateur_Images
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de FEN_Explorateur_Images.ZR_DossiersFichiers
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de FEN_Explorateur_Images.ZR_DossiersFichiers.ATT_CheminComplet
////////////////////////////////////////////////////////////////////////////
...
// Pas de traitement pour le champ FEN_Explorateur_Images.ZR_DossiersFichiers.ATT_CheminComplet
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°2 de FEN_Explorateur_Images.ZR_DossiersFichiers.ATT_Selection
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
...
// Pas de traitement pour le champ FEN_Explorateur_Images.ZR_DossiersFichiers.ATT_Selection
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°3 de FEN_Explorateur_Images.ZR_DossiersFichiers.ATT_Type
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
...
// Pas de traitement pour le champ FEN_Explorateur_Images.ZR_DossiersFichiers.ATT_Type
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°4 de FEN_Explorateur_Images.ZR_DossiersFichiers.IMG_Logo
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2377450933130035961l);

super.setChecksum("622950464");
...
super.setPositionInitiale(4, 24);

super.setTailleInitiale(97, 60);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°5 de FEN_Explorateur_Images.ZR_DossiersFichiers.INT_Selected
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de FEN_Explorateur_Images.ZR_DossiersFichiers.INT_Selected.INT_Selected_Option_0
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
...
/**
 * Initialise tous les champs de FEN_Explorateur_Images.ZR_DossiersFichiers.INT_Selected
 */
public void initialiserSousObjets()
{
////////////////////////////////////////////////////////////////////////////
// Initialisation des champs de FEN_Explorateur_Images.ZR_DossiersFichiers.INT_Selected
////////////////////////////////////////////////////////////////////////////
...
super.setQuid(2377483196897663142l);

super.setChecksum("596256237");
...
super.setPositionInitiale(69, 1);
...
/**
 * Initialise tous les champs de FEN_Explorateur_Images.ZR_DossiersFichiers
 */
public void initialiserSousObjets()
{
////////////////////////////////////////////////////////////////////////////
// Initialisation des champs de FEN_Explorateur_Images.ZR_DossiersFichiers
////////////////////////////////////////////////////////////////////////////
super.initialiserSousObjets();
...
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setRectCompPrincipal(0,0,105,92);
super.setQuid(2377450933129773817l);

super.setChecksum("622698352");
...
super.setParamAffichage(0, 0, 3, 105, 92);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de FEN_Explorateur_Images.ACTB_ActionBar
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
...
super.setQuid(2377484579878634352l);
...
/**
 * Traitement: Déclarations globales de FEN_Explorateur_Images
 */
...
// tabChaine	est un tableau de chaînes	= [".jpg",".jpeg",".bmp","png",".gif",".ico",".tif"]
vWD_tabChaine = new WDTableauSimple(1, new int[]{0}, 0, 16);
vWD_tabChaine.setValeur(new WDSerie(new WDObjet[]{new WDChaineU(".jpg"), new WDChaineU(".jpeg"), new WDChaineU(".bmp"), new WDChaineU("png"), new WDChaineU(".gif"), new WDChaineU(".ico"), new WDChaineU(".tif")}));
...
// ResListeFichier = fListeFichier("/storage/emulated/0/Pictures/*.*", frRécursif + frInterruptible)
vWD_ResListeFichier.setValeur(WDAPIFichier.fListeFichier("/storage/emulated/0/Pictures/*.*",new WDEntier4(5)));
...
// 		ZR_DossiersFichiers[Indice].IMG_Logo	= UnFichier
mWD_ZR_DossiersFichiers.get(vWD_Indice).get("IMG_Logo").setValeur(parcours2.getVariableParcours());
...
////////////////////////////////////////////////////////////////////////////
// Création des champs de la fenêtre FEN_Explorateur_Images
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// Initialisation de la fenêtre FEN_Explorateur_Images
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
...
super.setQuid(2377450602409022212l);

super.setChecksum("619684791");

super.setNom("FEN_Explorateur_Images");
...
super.setTitre("Explorateur Images");
...
////////////////////////////////////////////////////////////////////////////
// Initialisation des champs de FEN_Explorateur_Images
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// Agencements de FEN_Explorateur_Images
////////////////////////////////////////////////////////////////////////////
...
{
return GWDPTono_CF.getInstance().mWD_FEN_Explorateur_Images;
}
}
/**
